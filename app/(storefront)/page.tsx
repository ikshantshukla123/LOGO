      ...
      <section className="px-8 md:px-20 py-24 flex flex-col md:flex-row items-center justify-between gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-6 max-w-xl">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-300 leading-7">
            ...
            Build your own <span className="font-semibold text-black dark:text-white">
              custom T-Shirt
            </span> with your artwork or logo.
          </p>
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a
              href="/custom"
              className="px-8 py-3 text-lg rounded-full border border-black dark:border-white text-black dark:text-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition shadow-md"
            >
              Customize
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            ...
            <p className="text-lg text-zinc-700 dark:text-zinc-300 leading-7">
              Upload your design, choose your style, pick size and color —
              and we’ll make a premium custom T-shirt just for you.
            </p>
